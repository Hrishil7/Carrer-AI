...
ACCENT = "#EC4899"   # Pink - vibrant accent
SUCCESS = "#10B981"  # Green
WARNING = "#F59E0B"  # Orange
ERROR = "#EF4444"    # Red
BG_GRADIENT = "linear-gradient(135deg, #09090B 0%, #1a1a2e 50%, #16213e 100%)"
CARD_BLUR = """
    ...
    * {{
    ...
    .hero {{
        ...
        background: linear-gradient(135deg, 
                    ...
                    radial-gradient(ellipse at bottom left, rgba(236, 72, 153, 0.15), transparent 70%);
    ...
    .btn-primary button:hover {{
        ...
        box-shadow: 0 12px 28px rgba(99,102,241,0.35),
                    0 4px 12px rgba(236,72,153,0.2) !important;
    }}
